...
var favouriteBook = Book(title: "kek", author: "kok", pages: 1488, price: 666)
print(favouriteBook)
/*:
...
struct Height {
    ...
    init(hieghtInCentimeters: Double) {
        self.heightInInches = hieghtInCentimeters * 0.3937
        self.heightInCentimeters = hieghtInCentimeters
    }
}
...
var testHeight = Height(heightInInches: 65)
print(testHeight)
testHeight = Height(hieghtInCentimeters: 1000)
print(testHeight)
...
var myHeight = Height(hieghtInCentimeters: 181)
print(myHeight)
