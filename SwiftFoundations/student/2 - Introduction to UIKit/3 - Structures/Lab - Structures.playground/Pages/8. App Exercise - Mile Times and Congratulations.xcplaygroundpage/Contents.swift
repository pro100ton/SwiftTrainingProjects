...
var rw = RunningWorkout(distance: 16.1, time: 72, elevation: 29)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congradulations! You have reached your daily steps goal!")
            }
        }
    }
    var goal: Int
    ...
    mutating func takeStep() {
        print("Taken a step forward")
        steps += 1
    }
}

var steps = Steps(steps: 998, goal: 1000)
steps.takeStep()
steps.takeStep()
steps.takeStep()
