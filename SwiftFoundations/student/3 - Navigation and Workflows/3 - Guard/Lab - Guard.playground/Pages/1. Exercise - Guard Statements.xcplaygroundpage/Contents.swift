...
func createUser() -> User? {
    guard let userName = firstNameTextField.text else { return nil }
    guard let userSecondName = lastNameTextField.text else { return nil }
    guard let userAge = ageTextField.text else { return nil }
    return User(firstName: userName, lastName: userSecondName, age: userAge)
}
